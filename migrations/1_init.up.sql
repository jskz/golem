...
INSERT INTO objects(id, zone_id, name, short_description, long_description, description, flags, item_type, value_1, value_2, value_3, value_4) VALUES (7, 1, 'wizard wizardry pointed hat cone', 'a pointed hat', 'An unassuming cone encircled by a wide brum suggests wizardry afoot.', 'An i-conic cap perfectly fit for the magical mindspace.', 69, 'armor', 3, 3, 3, 10);
...
INSERT INTO objects(id, zone_id, name, short_description, long_description, description, flags, item_type, value_1, value_2, value_3, value_4) VALUES (9, 1, 'mithril vest', 'a mithril vest', 'A mest of mithril links sits here.', 'Interweaved links of mithril providing some defense against slashing weapons.', 261, 'armor', 15, 15, 15, 2);
INSERT INTO objects(id, zone_id, name, short_description, long_description, description, flags, item_type, value_1, value_2, value_3, value_4) VALUES (10, 1, 'leather boots', 'a pair of leather boots', 'Some unopinonated leather boots were left here.', 'These plain leather boots are only arguably better than nothing.', 32773, 'armor', 2, 2, 2, 1);
...
VALUES
    (1, 'Admin', '$2a$10$sS5pzrKaD9qeG3ntkT7.gOohefnxSy/9OHR/p1uImyTL2edzYeJzW', 1, 1, 1, 3, 60, 5000, 0, 0, 100, 100, 100, 100, 100, 100, 18, 18, 18, 18, 18, 18, 18);
