...
func (game *Game) InitScripting() error {
	...
	furnitureFlagsConstantsObj := game.vm.NewObject()
	furnitureFlagsConstantsObj.Set("FURNITURE_STAND_AT", FURNITURE_STAND_AT)
	furnitureFlagsConstantsObj.Set("FURNITURE_STAND_ON", FURNITURE_STAND_ON)
	furnitureFlagsConstantsObj.Set("FURNITURE_STAND_IN", FURNITURE_STAND_IN)
	furnitureFlagsConstantsObj.Set("FURNITURE_SIT_AT", FURNITURE_SIT_AT)
	furnitureFlagsConstantsObj.Set("FURNITURE_SIT_ON", FURNITURE_SIT_ON)
	furnitureFlagsConstantsObj.Set("FURNITURE_SIT_IN", FURNITURE_SIT_IN)
	furnitureFlagsConstantsObj.Set("FURNITURE_REST_AT", FURNITURE_REST_AT)
	furnitureFlagsConstantsObj.Set("FURNITURE_REST_ON", FURNITURE_REST_ON)
	furnitureFlagsConstantsObj.Set("FURNITURE_REST_IN", FURNITURE_REST_IN)
	furnitureFlagsConstantsObj.Set("FURNITURE_SLEEP_AT", FURNITURE_SLEEP_AT)
	furnitureFlagsConstantsObj.Set("FURNITURE_SLEEP_ON", FURNITURE_SLEEP_ON)
	furnitureFlagsConstantsObj.Set("FURNITURE_SLEEP_IN", FURNITURE_SLEEP_IN)

	charFlagsConstantsObj := game.vm.NewObject()
	charFlagsConstantsObj.Set("CHAR_IS_PLAYER", CHAR_IS_PLAYER)
	charFlagsConstantsObj.Set("CHAR_SENTINEL", CHAR_SENTINEL)
	charFlagsConstantsObj.Set("CHAR_STAY_AREA", CHAR_STAY_AREA)
	charFlagsConstantsObj.Set("CHAR_AGGRESSIVE", CHAR_AGGRESSIVE)
	charFlagsConstantsObj.Set("CHAR_TRAIN", CHAR_TRAIN)
	charFlagsConstantsObj.Set("CHAR_PRACTICE", CHAR_PRACTICE)
	charFlagsConstantsObj.Set("CHAR_HEALER", CHAR_HEALER)
	charFlagsConstantsObj.Set("CHAR_SHOPKEEPER", CHAR_SHOPKEEPER)
	...
	utilObj.Set("findCharacter", game.vm.ToValue(FindCharacterTarget))
	...
	utilObj.Set("characterFlagNames", game.vm.ToValue(CharacterFlagNames))
	utilObj.Set("affectedFlagNames", game.vm.ToValue(AffectedFlagNames))
	utilObj.Set("positionName", game.vm.ToValue(PositionName))
	utilObj.Set("statName", game.vm.ToValue(StatName))
	utilObj.Set("characterStat", game.vm.ToValue(CharacterStat))
	utilObj.Set("characterName", game.vm.ToValue(CharacterName))
	utilObj.Set("characterTypeName", game.vm.ToValue(CharacterTypeName))
	utilObj.Set("characterLocationName", game.vm.ToValue(CharacterLocationName))
	utilObj.Set("effectDuration", game.vm.ToValue(EffectDurationDescription))
	utilObj.Set("effectDescription", game.vm.ToValue(EffectDescription))
	utilObj.Set("resourcePercentage", game.vm.ToValue(resourcePercentage))
	utilObj.Set("severityColourFromPercentage", game.vm.ToValue(SeverityColourFromPercentage))
	...
	obj.Set("FurnitureFlags", furnitureFlagsConstantsObj)
